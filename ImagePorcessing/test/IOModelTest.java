...
public class IOModelTest {
  ...
  public void testFlip() {
    //horizontal
    mock.getUpdated(Flip, 0, "horizontal");
    ...
    //vertical
    mock.getUpdated(Flip, 0, "vertical");
  ...
  public void testGreyScale() {
    //red
    mock.getUpdated(GreyScale, 0, "red");
    ...
    //green
    mock1.getUpdated(GreyScale, 0, "green");
    ...
    //blue
    mock2.getUpdated(GreyScale, 0, "blue");
    ...
    //maxValue
    mock3.getUpdated(GreyScale, 0, "max");
    ...
    //intensity
    mock4.getUpdated(GreyScale, 0, "intensity");
    ...
    //luma
    mock5.getUpdated(GreyScale, 0, "luma");
  ...
  public void testLumaGreyscale() {
    //luma
    mock5.getUpdated(LumaGreyScale, 0, "");
    Pixel[][] luma = new Pixel[2][2];
    luma[0][0] = new EightBitPixelModel(new ArrayList<>(Arrays.asList(1, 1, 1)));
  ...
  public void testGreyScaleInvalid() {
    mock.getUpdated(GreyScale, 0, "23");
  }
  ...
  public void testGreyScaleInvalid1() {
    mock.getUpdated(GreyScale, 0, "adwdasfdgs");
  }
  ...
  public void testFlipInvalid() {
    mock.getUpdated(Flip, 0, "/.?@031asdas");
  }
