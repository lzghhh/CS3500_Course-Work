...
public class SwingGuiView extends JFrame implements MarbleSolitaireGuiView {
  ...
  /**
   * This is the constructor for the GUI view class that visulize the whole game.
   * @param state The input MarbleSolitaireModel.
   */
  ...
  /**
   * This is the method for getting update for each step made by the player.
   */
  public void refresh() {
    //refresh the score
